...
namespace DSA_Tracker.Migrations.IdentityDb
{
    ...
    [Migration("20220813031605_BinarySearchDotComMigrationWithCompany")]
    partial class BinarySearchDotComMigrationWithCompany
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DSA_Tracker.Areas.Identity.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DSA_Tracker.Models.Problem", b =>
                {
                    b.HasOne("DSA_Tracker.Areas.Identity.Data.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DSA_Tracker.Areas.Identity.Data.ApplicationUser", null)
                        .WithMany()
